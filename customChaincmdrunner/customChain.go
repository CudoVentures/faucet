...
func (r Runner) Gentx(
	...
	options ...customChaincmd.GentxOption,
...
func (r Runner) BankSend(ctx context.Context, fromAccount, toAccount, amount string, fees string) error {
	b := newBuffer()
	opt := []step.Option{
		r.chainCmd.BankSendCommand(fromAccount, toAccount, amount, fees),
	}
